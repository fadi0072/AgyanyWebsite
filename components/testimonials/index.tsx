...
export default function Testimonials() {
  ...
  return (
    <section className="relative bg-[url('/testimonials-bg.png')] bg-contain bg-no-repeat bg-bottom-left  py-26 md:py-20">
      <div className="container mx-auto px-6 mb-10 md:mb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5 flex justify-center"></div>
          ...
          <div className="lg:col-span-7">
            <Slider {...settings}>
              {testimonials.map((t, index) => (
                <div
                  key={index}
                  className="border p-4 md:p-10 rounded-2xl border-[#FFF] bg-transparent backdrop-blur-[5.55px] h-[273px]"
                >
                  <p className="text-[#10052F] font-['Plus_Jakarta_Sans'] text-[20px] pb-2 font-semibold">
                    “{t.quote}”
                  </p>
                  <p className="text-[#297F95] font-['Sofia_Sans'] text-[18px] font-bold">
                    {t.author}
                  </p>
                </div>
              ))}
