  ...
  return (
    <>
      ...
      <section className="relative  py-16 px-4 md:px-0 ">
        ...
        <img src="/vision.png" alt="" className="w-100 relative -top-55 " />
        <div className="mb-10 -mt-[200px] container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 ">
            ...
            <div className="flex flex-col justify-center text-left space-y-5">
              <div>
                ...
                <SlideUp delay={0.2}>
                  <h2 className="text-xl md:text-2xl mb-4 font-semibold font-['Plus_Jakarta_Sans'] wrap-break-word leading-7">
                ...
                <SlideUp delay={0.4}>
                  <h3 className="text-lg md:text-xl wrap-break-word font-normal font-['Roboto'] leading-7">
      ...
      <section className="py-6 md:py-16 mt-10 px-4 md:px-0 bg-[url('/cards-bg.png')] bg-cover bg-center">
        <div className="relative container mx-auto">
          ...
          <div className="grid grid-cols-12 gap-10 ">
            <div className="col-span-9 md:col-span-6  lg:col-span-3 ">
              <SlideUp delay={0.3}>
                <div className="flex flex-col items-start justify-between rounded-[24px] border border-[#FFF] bg-[rgba(246,246,246,0.4)] backdrop-blur-[5.55px] h-[273px] pt-6 px-4 pb-10">
                  <Image src="/p1.png" alt="Ambroxol" width={50} height={50} className=" mb-4" />
                  <h3 className="text-[#0A0A0A] font-['Plus_Jakarta_Sans'] text-xl md:text-[24px] font-semibold">
      ...
      <section className="relative container mx-auto py-8 md:py-16  px-4 md:px-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 mb-30">
      ...
      <section className=" bg-[url('/kang.png')] px-4 md:px-0 mb-10  bg-contain bg-no-repeat py-25 bg-center flex items-center justify-center">
        <div className="w-full mx-auto max-w-[669px] bg-[#E4F7F9] rounded-[16px] p-6 ">
          {/* Left Section */}
          <div className="text-[#297F95] max-w-max bg-white mx-auto  font-['Plus_Jakarta_Sans'] text-[18px] font-bold leading-normal rounded-[400px]  px-6 py-3">
            Corporate Presentation
          </div>
          <div className="w-full pt-16 flex flex-col sm:flex-row items-center sm:items-start justify-between gap-4">
            <h2 className="text-[#0A0E0D] text-[24px] text-center font-semibold font-['Plus_Jakarta_Sans']">
              Investors Pitch
            </h2>
